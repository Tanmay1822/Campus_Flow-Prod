...
const Spinner = ({ text = "Loading..." }) => (
  <div className="flex flex-col justify-center items-center h-full my-10">
    ...
    <p className="mt-4 text-bronco/60">{text}</p>
  </div>
);
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      <button
        ...
        className="w-full px-3 py-2 border rounded-md bg-stone border border-bronco/10 shadow-sm text-left overflow-hidden whitespace-nowrap text-ellipsis bg-white/50 text-bronco border-bronco/10"
      >
        <span
          className={
      ...
      {isOpen && (
        <div className="absolute z-10 w-full mt-1 bg-stone border border-bronco/10 shadow-sm border rounded-md shadow-lg max-h-60 overflow-y-auto bg-white/50 text-bronco border-bronco/10">
          <div className="p-2">
            <input
              type="text"
              placeholder="Search..."
          ...
          <div className="p-2 border-t flex gap-2">
            ...
            <button
              ...
              className="bg-stone/50 text-bronco px-3 rounded-md hover:bg-ironwood text-bronco font-semibold text-sm font-semibold"
            >
              Add
            </button>
          </div>
...
const LoginPage = ({ onLoginSuccess, setPage }) => {
  ...
  return (
    <div className="max-w-md w-full bg-stone border border-bronco/10 shadow-sm p-8 rounded-xl shadow-lg">
      ...
      <form onSubmit={submitHandler}>
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full mt-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-mesa-clay/50 bg-white/50 text-bronco border-bronco/10"
            required
          />
        </div>
        <div className="mb-6">
        ...
        <button
          type="submit"
          className="w-full bg-mesa-clay text-creme py-2 rounded-lg hover:bg-mesa-clay/80 shadow-lg transition font-semibold disabled:bg-gray-400"
          disabled={loading}
        >
          {loading ? "Logging In..." : "Login"}
        </button>
      </form>
      <p className="text-center text-sm text-bronco/70 mt-4">
        Don't have an account?{" "}
        <button
          onClick={() => setPage("register")}
          className="font-semibold text-bronco hover:underline"
        >
          Register here
        </button>
      </p>
...
const AttendancePage = ({ batchName, subject, teacherName, onBack }) => {
  ...
  return (
    <div className="bg-stone border border-bronco/10 shadow-sm p-6 rounded-xl shadow-lg bg-white/50 text-bronco border-bronco/10">
      <button
        onClick={onBack}
        className="mb-4 bg-stone/50 text-bronco px-3 py-1 rounded-md text-sm hover:bg-ironwood text-bronco font-semibold"
      >
        ← Back to Dashboard
      </button>
      <h2 className="text-2xl font-bold text-center mb-2">Take Attendance</h2>
      <p className="text-center text-bronco/70 mb-4">
        {batchName} - {subject}
      </p>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1">
          ...
          <button
            ...
            className="w-full mt-4 bg-mesa-clay text-creme font-semibold py-2 rounded-md hover:bg-mesa-clay/80 shadow-lg disabled:bg-gray-400"
          >
            Capture Attendance
          </button>
        </div>
        <div className="flex-1 border rounded-lg p-4 bg-white/5 bg-white/50 text-bronco border-bronco/10">
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              className="flex-1 bg-mesa-clay text-creme font-semibold py-2 rounded-md hover:bg-mesa-clay disabled:bg-gray-400"
            >
            ...
            <button
              ...
              className="flex-1 bg-white/50 text-creme font-semibold py-2 rounded-md hover:bg-gray-600 disabled:bg-gray-400"
            >
              Export Excel
            </button>
          </div>
  ...
  return (
    <div className="w-full">
      <div className="bg-stone border border-bronco/10 shadow-sm p-6 sm:p-8 rounded-xl">
        <h2 className="text-2xl font-bold text-center mb-4 text-bronco">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          <div>
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-mesa-clay text-creme font-semibold py-2 rounded-md hover:bg-mesa-clay/80 shadow-lg disabled:bg-gray-400"
                disabled={isProcessing || !photoFile || !selectedBatch}
              >
                {isProcessing ? "Processing..." : "3. Recognize Students"}
              </button>
            </div>
            <p className="text-center text-bronco/70 mt-4 text-sm font-semibold">
              {status}
            </p>
            {photoPreview && (
              <img
          ...
          <div className="border rounded-lg p-4 bg-white/5 h-full bg-white/50 text-bronco border-bronco/10">
            <h3 className="text-xl font-bold text-bronco/80 mb-4">
              Recognition Results
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <h4 className="font-semibold text-mesa-clay">
              ...
              <div>
                <h4 className="font-semibold text-bronco">
            ...
            <button
              ...
              className="w-full mt-6 bg-mesa-clay text-creme font-semibold py-2 rounded-md hover:bg-mesa-clay disabled:bg-gray-400"
...
const BulkUploadPage = ({ batches, onBack }) => {
  ...
  return (
    <div className="w-full">
      <div className="bg-stone border border-bronco/10 shadow-sm p-6 sm:p-8 rounded-xl">
        <h2 className="text-2xl font-bold text-center mb-6 text-bronco">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-bronco/60 mb-2">
    ...
    <div className="container mx-auto p-4 sm:p-8 max-w-7xl">
      <header className="flex flex-col sm:flex-row justify-between items-center text-center sm:text-left mb-6">
        <div>
          <button
            onClick={() => navigate("/")}
            className="mb-4 bg-white text-bronco font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-stone transition-colors"
          >
            ← Back to Home
          </button>
          <h1 className="text-4xl font-bold text-bronco drop-shadow-sm">
      ...
      <div className="border-b border-bronco/10 mb-8">
      ...
      {activeTab === "timetable" && (
        <>
          <div className="w-full mb-8">
            <div className="bg-stone border border-bronco/10 shadow-sm p-6 sm:p-8 rounded-xl">
              {" "}
              <h3 className="text-xl font-bold text-bronco/80 mb-6 text-center">
                Manage Students
              </h3>{" "}
              <form onSubmit={handleAddStudent} className="space-y-3">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border rounded-md bg-stone border border-bronco/10 shadow-sm bg-white/50 text-bronco border-bronco/10"
                  required
                >
              ...
              <div className="mt-4 h-48 overflow-y-auto border rounded-md bg-white/50 text-bronco border-bronco/10">
                <div className="text-sm p-2 border-b border-bronco/10 font-semibold text-bronco/80">
                  Existing Students
                </div>
                {students.map((s) => (
                  <div key={s._id} className="text-sm p-2 border-b border-bronco/10">
      ...
      {activeTab === "photoAttendance" && (
        <PhotoAttendancePage batches={batches} userInfo={userInfo} />
      )}

      {activeTab === "bulkUpload" && (
        <BulkUploadPage batches={batches} />
      )}
  ...
  return (
    <div className="space-y-6">
      <div className="bg-stone border border-bronco/10 shadow-sm p-6 rounded-xl shadow-lg bg-white/50 text-bronco border-bronco/10">
        ...
        <div className="flex gap-4 items-end">
          ...
          <button
            ...
            className="bg-mesa-clay text-creme px-4 py-2 rounded-md hover:bg-mesa-clay/80 shadow-lg disabled:bg-gray-400"
      ...
      {attendanceData.length > 0 && (
        <div className="bg-stone border border-bronco/10 shadow-sm p-6 rounded-xl shadow-lg bg-white/50 text-bronco border-bronco/10">
          <h4 className="text-lg font-semibold text-bronco/80 mb-4">
            Attendance Summary
          </h4>
          <div className="overflow-x-auto">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-bronco/10">
                  <th className="text-left p-3 font-semibold text-bronco/70">
                    Date
                  </th>
                  <th className="text-left p-3 font-semibold text-bronco/70">
                    Subject
              ...
              <tbody>
                {attendanceData.map((record, index) => (
                  <tr key={index} className="border-b border-bronco/10">
...
// --- MAIN APP CONTROLLER ---
function FacialRecognitionApp({ userInfo, onLogout }) {
  const [page, setPage] = useState({ name: "dashboard", props: {} });
  ...
  return (
    <div className="bg-creme text-bronco min-h-screen font-sans">{renderContent()}</div>
  );
}
